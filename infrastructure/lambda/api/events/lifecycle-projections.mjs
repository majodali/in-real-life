...
const EDITABLE_FIELDS = new Set(['title', 'description', 'startTime', 'endTime', 'location', 'timesApproximate', 'cost', 'maxAttendance', 'meetingSpot', 'shape', 'localityId', 'eventTypeId', 'eventTypeSource']);
