...
export const STUB_ONBOARDING_EXTRACTION = {
  ...
  strengthsToOffer: [],
  envelope: {
    groupSize: { comfort: 'small', position: 'small', provenance: 'inferred', confidence: 'medium' },
    structure: {
      comfort: 'activity-anchored',
      position: 'activity-anchored',
      growthEdge: 'open-conversation',
      edgeToward: 'open-conversation',
      provenance: 'inferred',
      confidence: 'low',
    },
    familiarity: { comfort: 'needs-known-face', position: 'needs-known-face', provenance: 'inferred', confidence: 'low' },
    role: { comfort: 'happy-to-attend', position: 'happy-to-attend', provenance: 'inferred', confidence: 'low' },
    novelty: { comfort: 'prefers-ritual', position: 'prefers-ritual', provenance: 'inferred', confidence: 'low' },
    energy: {
