...
| D32 | Event policy: IRL events must be genuine community gatherings — **no** dating-as-primary-purpose, business/sales/recruiting, unlawful/hostile exclusionary listings, or unsafe/illegal activities; grey areas (faith, politics, fundraisers, networking, paid) TBD; enforced through the organiser flow with the framing principle (every decline paired with a path) | `event-policy.md` |
