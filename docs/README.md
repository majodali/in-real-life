...
- `localities-and-constraints.md` — **(proposal)** the curated locality register (effort bands — here/nearby/a-trip/far — no coordinates) and structured constraints: travel reach as a suggestions-only gate, time windows as soft fit, both member-correctable.
